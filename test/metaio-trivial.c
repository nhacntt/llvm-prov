...
void foo()
{
	...
	// PROVCHECK: call [[SSIZE:i[0-9]+]] @metaio_read([[INT]] 0, i8* [[X_AS_BUFFER]], [[SSIZE]] {{[0-9]+}}, %struct.metaio* [[METAIO]])
	read(0, &x, sizeof(x));
	...
	// PROVCHECK: call [[SSIZE]] @metaio_write([[INT]] 1, i8* [[Z_AS_BUFFER]], [[SSIZE]] 4, %struct.metaio* [[METAIO]])
	write(1, &z, sizeof(z));
}
